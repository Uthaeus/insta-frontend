...
function TopicDetail() {
  ...
  return (
    <div className="topic-detail">
      <h1 className="topic-detail-title">{topic.topic?.title}</h1>
      <hr />

      <div className="topic-detail-content">
        <div className="topic-detail-content-user-info-wrapper">
          <h4 className="topic-detail-content-user-info-title">User Info</h4>
          <p className="topic-detail-content-user-info-item">
            Username:{" "}
            <span className="topic-detail-content-user-info-name">
              {topic.topic?.user && topic.topic.user.username}
            </span>
          </p>
          <p className="topic-detail-content-user-info-item">
            Email:{" "}
            <span className="topic-detail-content-user-info-email">
              {topic.topic?.user && topic.topic.user.email}
            </span>
          </p>
        </div>
        ...
        <div className="topic-detail-content-user-comments-wrapper">
          ...
          {topic.topic?.user?.comments &&
            topic.topic.user.comments.map((comment) => (
        ...
        <div className="topic-detail-content-user-posts-wrapper">
          ...
          {topic.topic?.user?.posts &&
            topic.topic.user.posts.map((post) => (
      ...
      {topic.posts?.length > 0 && (
        <div className="topic-detail-posts-wrapper">
          <h4 className="topic-detail-posts-title">Posts</h4>

          <div className="topic-detail-posts-list">
            {topic?.posts &&
      ...
      <Link to="/options" className="topic-detail-back">
        Back
      </Link>
    </div>
  );
